...
var begin_qns ={
	type:"text",
	text:'<p class="instructions">We will now ask you to complete a debrief questionnaire.</p>' +
...
var videogameexp_qn = [
	'1) On a scale of 1 to 3, I would rate my experience playing video games as:',
	'2) On a scale of 1 to 3, I would rate my experience playing video games that are focused on driving as:'
];

var videogameexp_scale=[
	"1) No experience at all",
	"2) Some experience",
	"3) A lot of experience"
];

var videogameexp = { type: "survey-multi-choice",
questions: [videogameexp_qn],
options: [[videogameexp_scale,videogameexp_scale]],
required: [[true,true]],
horizontal: true,
preamble: ['<strong>People differ in the amount of video game experience they have. Read each statement and rate according to the labels. Do not spend too much time on any statment. Answer quickly and honestly.'],
data:{label: 'videogameexp', trialType: 'quest'}
};
